    ...
    <div class="d-flex" style="height: 100vh;">
        <div class="bg-success text-white sidebar">
            <ul class="nav flex-column pt-3">
                ...
                <li class="nav-item">
                    <a id="about-link" href="manage_admin.php" class="nav-link">
                        <i class="nav-icon fas fa-info-circle"></i>
                        Admin
                    </a>
                </li>
                <li class="nav-item">
                    <a id="services-link" href="manage_categories.php" class="nav-link">
                        <i class="nav-icon fas fa-concierge-bell"></i>
                        Categories
                    </a>
                </li>
                <li class="nav-item">
                    <a id="contact-link" href="manage_products.php" class="nav-link">
                        <i class="nav-icon fas fa-envelope"></i>
                        Products
                    </a>
                </li>
                <li class="nav-item">
                    <a id="help-link" href="manage_orders.php" class="nav-link">
                        <i class="nav-icon fas fa-question-circle"></i>
                        Orders
                    </a>
                </li>
                <li class="nav-item">
                    <a id="help-link" href="manage_order_details.php" class="nav-link">
                        <i class="nav-icon fas fa-question-circle"></i>
                        Order_Details
                    </a>
                </li>
                <li class="nav-item">
                    <a id="help-link" href="manage_payments.php" class="nav-link">
                        <i class="nav-icon fas fa-question-circle"></i>
                        Payments
                    </a>
                </li>
                <li class="nav-item">
                    <a id="help-link" href="manage_shipping.php" class="nav-link">
                        <i class="nav-icon fas fa-question-circle"></i>
                        Shipping
                    </a>
                </li>
